module github.com/Bianca-29MSP/AcademicToken/tools/course_processor
...
require (
	github.com/Bianca-29MSP/AcademicToken v0.0.0
...
replace github.com/Bianca-29MSP/AcademicToken => ../../
