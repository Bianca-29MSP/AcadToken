...
var (
	...
	fd_GenesisState_courseContentList     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_courseContentList = md_GenesisState.Fields().ByName("courseContentList")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.CourseContentList) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_5_list{list: &x.CourseContentList})
		if !f(fd_GenesisState_courseContentList, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "academictoken.curriculum.GenesisState.courseContentList":
		return len(x.CourseContentList) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "academictoken.curriculum.GenesisState.courseContentList":
		...
		listValue := &_GenesisState_5_list{list: &x.CourseContentList}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "academictoken.curriculum.GenesisState.courseEquivalenceList":
		...
		return protoreflect.ValueOfList(value)
	case "academictoken.curriculum.GenesisState.courseContentList":
		if x.CourseContentList == nil {
			x.CourseContentList = []*CourseContent{}
		}
		value := &_GenesisState_5_list{list: &x.CourseContentList}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: academictoken.curriculum.GenesisState"))
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.CourseContentList) > 0 {
			for _, e := range x.CourseContentList {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.CourseContentList) > 0 {
			for iNdEx := len(x.CourseContentList) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.CourseContentList[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CourseContentList", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.CourseContentList = append(x.CourseContentList, &CourseContent{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.CourseContentList[len(x.CourseContentList)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type GenesisState struct {
	...
	CourseContentList     []*CourseContent     `protobuf:"bytes,5,rep,name=courseContentList,proto3" json:"courseContentList,omitempty"`
}
...
func (x *GenesisState) GetCourseContentList() []*CourseContent {
	if x != nil {
		return x.CourseContentList
	}
	return nil
}
...
var file_academictoken_curriculum_genesis_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x61, 0x6c, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2d,
	0x61, 0x63, 0x61, 0x64, 0x65, 0x6d, 0x69, 0x63, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2f, 0x63, 0x75,
	0x72, 0x72, 0x69, 0x63, 0x75, 0x6c, 0x75, 0x6d, 0x2f, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x5f,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc7, 0x03,
	...
	,
	...
	,
...
var file_academictoken_curriculum_genesis_proto_goTypes = []interface{}{
	...
	(*CourseContent)(nil),     // 5: academictoken.curriculum.CourseContent
}
var file_academictoken_curriculum_genesis_proto_depIdxs = []int32{
	...
	5, // 4: academictoken.curriculum.GenesisState.courseContentList:type_name -> academictoken.curriculum.CourseContent
